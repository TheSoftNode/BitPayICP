...
//                     {/* Wallet Widget Preview - Click to navigate to full wallet page */}
//                     <div className="cursor-pointer" onClick={navigateToWallet}>
//                         <WalletWidgetPreview />
//                     </div>

//                     {/* Quick Stats Card - Replacing Integration Widget */}
//                     <div>
//                         <Card>
...
//                                 <div>
//                                     <p className="text-xs md:text-sm font-medium">Bitcoin Network</p>
...
//                                 <div className="w-2 h-2 md:w-3 md:h-3 rounded-full bg-green-500 mr-2 md:mr-3"></div>
//                                 <div>
//                                     <p className="text-xs md:text-sm font-medium">ICP Network</p>
//                                     <p className="text-xs text-muted-foreground">Operational</p>
//                                 </div>
//                             </div>
...
//                                 <div className="w-2 h-2 md:w-3 md:h-3 rounded-full bg-green-500 mr-2 md:mr-3"></div>
//                                 <div>
//                                     <p className="text-xs md:text-sm font-medium">ckBTC Minting</p>
//                                     <p className="text-xs text-muted-foreground">Operational</p>
//                                 </div>
//                             </div>
...
//                                 <div className="w-2 h-2 md:w-3 md:h-3 rounded-full bg-green-500 mr-2 md:mr-3"></div>
//                                 <div>
//                                     <p className="text-xs md:text-sm font-medium">API Services</p>
//                                     <p className="text-xs text-muted-foreground">Operational</p>
//                                 </div>
//                             </div>
//                         </div>
