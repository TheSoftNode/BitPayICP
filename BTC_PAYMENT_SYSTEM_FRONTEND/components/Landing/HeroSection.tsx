...
const HeroSection = () => {
    ...
    // Refined background particle props with more violet and less yellow/orange
    const particles = [
        { id: 1, size: "w-96 h-96", position: "absolute -top-32 -right-24", color: "bg-violet-600/15", delay: 0 },
        { id: 2, size: "w-80 h-80", position: "absolute top-1/4 -left-20", color: "bg-indigo-500/10", delay: 0.1 },
        { id: 3, size: "w-72 h-72", position: "absolute bottom-20 right-1/4", color: "bg-blue-500/10", delay: 0.2 },
        { id: 4, size: "w-64 h-64", position: "absolute top-1/2 right-10", color: "bg-purple-600/15", delay: 0.3 },
        { id: 5, size: "w-48 h-48", position: "absolute -bottom-10 left-1/3", color: "bg-violet-500/10", delay: 0.4 },
    ];
    ...
    return (
        <section className="relative pt-32 pb-32 overflow-hidden min-h-screen flex items-center">
            ...
            {/* Animated decorative elements for the wave - updated colors */}
            <motion.div
                className="absolute bottom-10 left-1/4 w-4 h-4 rounded-full bg-violet-500/30 z-10"
                animate={{
                    y: [0, -15, 0],
                    opacity: [0.3, 0.6, 0.3]
                }}
            ...
            />
            <motion.div
                className="absolute bottom-8 right-1/3 w-3 h-3 rounded-full bg-indigo-400/30 z-10"
                animate={{
                    y: [0, -10, 0],
                    opacity: [0.2, 0.5, 0.2]
                }}
            ...
            <div className="absolute inset-0 z-0">
                ...
                {/* Updated gradient overlay with more violet */}
                <div className="absolute inset-0 bg-gradient-to-br from-transparent via-white/5 to-violet-500/10 dark:from-transparent dark:via-gray-900/10 dark:to-violet-900/10"></div>
            </div>
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center pb-16">
                    ...
                    >
                        ...
                        >
                            <div className="flex items-center">
                                <div className="w-6 h-6 rounded-full bg-gradient-to-br from-violet-500 to-indigo-400 flex items-center justify-center text-white font-bold text-xs mr-2">₿</div>
                                <span className="text-sm font-medium">
                                    BTC: <motion.span
                                        key={btcPrice}
                                        initial={{ opacity: 0.5, y: 10 }}
                                        animate={{ opacity: 1, y: 0 }}
                                        transition={{ duration: 0.3 }}
                                        className="text-yellow-500 dark:text-orange-400"
                                    >
                                        ${btcPrice.toLocaleString()}
                                    </motion.span>
                                </span>
                        ...
                        >
                            <motion.span
                                className="bg-gradient-to-r from-violet-600 to-indigo-400 bg-clip-text text-transparent inline-block"
                                animate={{
                                    backgroundPosition: ['0% center', '100% center', '0% center'],
                                }}
                                transition={{ duration: 10, repeat: Infinity, ease: "linear" }}
                        ...
                        >
                            <Button
                                size="lg"
                                className="bg-gradient-to-r from-violet-600 to-indigo-400 hover:from-violet-700 hover:to-indigo-500 text-white relative overflow-hidden group"
                            >
                                <motion.span
                                    className="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 duration-300"
                                    animate={{
                            ...
                            <Button
                                size="lg"
                                variant="outline"
                                className="border-2 hover:bg-violet-500/5 hover:border-violet-500/50 transition-all duration-300"
                            >
                                Learn More
                            </Button>
                        </motion.div>
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.7, delay: 0.4 }}
                    >
                        {/* Animated floating circles decoration - updated colors */}
                        <motion.div
                            className="absolute -right-4 -top-4 w-20 h-20 bg-gradient-to-br from-violet-400/20 to-indigo-300/20 rounded-full z-0"
                            animate={{
                                y: [0, -15, 0],
                                scale: [1, 1.1, 1]
                            }}
                        ...
                        <div className="relative z-10">
                            ...
                            >
                                ...
                                <motion.div
                                    className="absolute inset-0 z-0 border-2 border-transparent rounded-2xl"
                                    style={{
                                        background: "linear-gradient(90deg, rgba(124,58,237,0) 0%, rgba(124,58,237,0.3) 50%, rgba(99,102,241,0) 100%)",
                                        backgroundSize: "200% 100%",
                                        maskImage: "linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)",
                                        maskComposite: "exclude",
                                        WebkitMaskComposite: "xor",
                                ...
                                <div className="bg-gradient-to-r from-violet-600 to-indigo-400 h-3" />
                                <div className="p-6">
                                    <div className="flex items-center mb-6">
                                        <motion.div
                                            className="w-10 h-10 rounded-full bg-gradient-to-br from-violet-600 to-indigo-400 flex items-center justify-center text-white font-bold"
                                            whileHover={{ rotate: 360, scale: 1.1 }}
                                            transition={{ duration: 0.6 }}
                                        >
                                            ₿
                                    ...
                                    <div className="bg-gray-100 dark:bg-gray-900 p-4 rounded-lg flex justify-center mb-6 relative overflow-hidden">
                                        <motion.div
                                            className="absolute inset-0 bg-gradient-to-r from-violet-500/5 via-indigo-500/5 to-blue-500/5 opacity-0"
                                            animate={{ opacity: [0, 0.5, 0] }}
                                            transition={{ duration: 3, repeat: Infinity }}
                                        />
                                        <div className="w-32 h-32 bg-white dark:bg-black p-2 rounded-lg relative">
                                            ...
                                            {/* Scanning animation - updated color */}
                                            <motion.div
                                                className="absolute inset-0 bg-gradient-to-b from-transparent via-violet-500/30 to-transparent"
                                                style={{ height: "4px" }}
                                                animate={{ top: ["0%", "100%", "0%"] }}
                                                transition={{ duration: 2.5, repeat: Infinity }}
                                            />
                                    ...
                                    <AnimatePresence>
                                        ...
                                        >
                                            ...
                                            >
                                                <span className="text-gray-500 dark:text-gray-400">Status:</span>
                                                <motion.span
                                                    className="font-medium text-indigo-600 dark:text-indigo-400 flex items-center"
                                                >
                                                    <motion.span
                                                        className="inline-block w-2 h-2 rounded-full bg-indigo-600 dark:bg-indigo-400 mr-1"
                                                        animate={{ scale: [1, 1.5, 1] }}
                                                        transition={{ duration: 2, repeat: Infinity }}
                                                    />
                                                    Ready to Pay
                                    ...
                                    <Button className="w-full mt-6 bg-gradient-to-r from-violet-600 to-indigo-400 hover:from-violet-700 hover:to-indigo-500 text-white relative overflow-hidden group">
                                        <motion.span
                                            className="absolute inset-0 bg-white/10"
                                            initial={{ x: "-100%", opacity: 0 }}
                                            animate={{ x: "100%", opacity: 0.3 }}
                        ...
                        {/* Enhanced decorative elements - updated colors */}
                        <motion.div
                            className="absolute -bottom-6 -right-6 w-64 h-64 bg-indigo-500/10 dark:bg-indigo-500/15 rounded-full blur-xl"
                            animate={{ scale: [1, 1.1, 1], opacity: [0.5, 0.7, 0.5] }}
                            transition={{ duration: 5, repeat: Infinity, repeatType: "reverse" }}
                        />
                        <motion.div
                            className="absolute -top-6 -left-6 w-48 h-48 bg-violet-500/10 dark:bg-violet-500/15 rounded-full blur-xl"
                            animate={{ scale: [1, 0.9, 1], opacity: [0.5, 0.8, 0.5] }}
                            transition={{ duration: 4, repeat: Infinity, repeatType: "reverse", delay: 1 }}
                        />
            ...
            {/* Background animated binary data flow - updated opacity for a more subtle effect */}
